<footer class="bg-dark py-3" style="margin-top: 10rem;" id='contact'>
  <div class="container">
      <div class="row justify-content-center">
          <div class="col-lg-7 mb-3">
          <div class="text-center">
                  <p class="text-muted para-desc mx-auto mt-3">That's all about me !</p>
              ...
              <div class="row text-center">
                  <div class="col-sm-6 footer-bar">
                      <div class="text-sm-left">
                          <p class="mb-0 footer-text para-desc mx-auto">&copy; 2023 Andry<i class="mdi mdi-heart text-danger"></i>.</p>
                      </div>
                  </div><!--end col-->
